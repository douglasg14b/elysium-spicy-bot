...
describe('isWithinBirthdayAnnouncementWindow', () => {
    ...
    it('allows the Pacific evening cutoff minus one minute', () => {
        expect(isWithinBirthdayAnnouncementWindow(new Date('2026-04-18T02:59:00.000Z'))).toBe(true);
    });
    ...
    it('blocks at 8 p.m. Pacific', () => {
        expect(isWithinBirthdayAnnouncementWindow(new Date('2026-04-18T03:00:00.000Z'))).toBe(false);
    });
});
